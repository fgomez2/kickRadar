...
import styles from './KickHeader.module.css'
        ...
        <header className="bg-black py-5 px-4 sm:py-6 sm:px-6 md:py-8">
            <div className="flex items-center justify-between ml-3 sm:ml-4 md:ml-6 mr-3 sm:mr-4 md:mr-6">
                ...
                <div className="flex items-center">
                    <h1 className={`${styles.titulo} text-white text-2xl sm:text-3xl md:text-4xl font-bold`}>kickRadar</h1>
                    <img src="/images/logo_radar.png" alt="KickRadar Logo" className="h-10 sm:h-12 md:h-14 lg:h-16 w-auto ml-2 sm:ml-3" />
                </div>
                
                {/* Barra de busqueda - Solo visible en pc y tablet */}
                <div id='barra_busqueda' className="hidden sm:block">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`${styles.barraBusqueda} bg-gray-900 border-2 border-cyan-400 text-white pl-10 pr-4 py-2 rounded-full 
                ...
                {/* Botones de autenticación - Solo visible en tablet y desktop */}
