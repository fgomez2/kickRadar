                ...
                <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 justify-items-center">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-center gap-4">
                            <a href="https://github.com/fgomez2" className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-white/5 hover:border-emerald-400 hover:text-emerald-300 transition-colors" aria-label="GitHub">
                            ...
                            <a href="https://www.linkedin.com/in/fernando-g%C3%B3mez-garc%C3%ADa-50562735a/" className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-white/5 hover:border-emerald-400 hover:text-emerald-300 transition-colors" aria-label="LinkedIn">
                                <svg viewBox="0 0 24 24" aria-hidden="true" className="h-5 w-5" fill="currentColor">
